...
public class Code{
	public static void main(String[] args)throws Exception
	{
		...
		File file = new File("/home/ccoew/3336/inputcode.asm");
        ...
        */
		...
		br.close();
		File file1 = new File("/home/ccoew/3336/Mnemonic.txt");
		...
		File lit1=new File("/home/ccoew/3336/lit.txt");
		
		if(lit1.exists()){
			lit1.delete();
		}
		File litfile=new File("/home/ccoew/3336/lit.txt");
		int cntlit=0;
		File ic1=new File("/home/ccoew/3336/ic.txt");
		if(ic1.exists()){
			ic1.delete();
		}
		File ic=new File("/home/ccoew/3336/ic.txt");
		FileWriter fr1=new FileWriter(ic);
		int lc=0;
		File sym1=new File("/home/ccoew/3336/sym.txt");
		if(sym1.exists()){
			sym1.delete();
		}
		File symfile=new File("/home/ccoew/3336/sym.txt");
		File poolt=new File("/home/ccoew/3336/pool.txt");
		if(poolt.exists()){
			poolt.delete();
		}
		File pool=new File("/home/ccoew/3336/pool.txt");
		...
		for(int i=0;i<tokens.size();i++)
		{
			...
			else if( (str.equals("ORIGIN")) ||(str.equals("EQU"))||(str.equals("END"))||(str.equals("LTORG")))
			{
				...
				int x=0;
		     		for(int y=0;y<lit.size();y++)
					{
						if( ( lit.get(y).value.equals(tokens.get(i).toString().substring(2,3)) ) && (lit.get(y).addr==0) ){
							...
							x=lit.get(y).seq;
							//---------
							fr1.write("\n"+lc+"          "+tokens.get(i).toString().substring(2,3));
							//-----------
							lc++;
							i++;
						}
				...
				fr1.write("\n"+lc+" (DL,01)  "+tokens.get(i+1).toString());
